    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6">
        <div className="w-full max-w-sm text-center space-y-6">
          ...
          <div className="rounded-2xl p-6" style={{ background: "hsl(var(--sage-light))" }}>
            <p className="text-[1.1rem] font-semibold mb-2">{t("auth.resetSentTitle")}</p>
            <p className="text-[0.82rem] text-muted-foreground leading-relaxed">
      ...
      <div className="w-full max-w-sm">
        ...
        {mode === "reset" ? (
          <div className="mb-8 text-center section-fade-in">
            <p className="text-[1.05rem] font-semibold mb-1.5">{t("auth.resetTitle")}</p>
            <p className="text-[0.8rem] text-muted-foreground leading-relaxed">{t("auth.resetIntro")}</p>
          </div>
        ) : (
          ...
          {mode === "login" && (
            <div className="text-right -mt-1">
              <button
                ...
                className="text-[0.72rem] text-muted-foreground hover:text-foreground transition-colors"
              >
